...
if("TRUE" STREQUAL "TRUE")
  set(lcd_monitor_SOURCE_PREFIX /opt/app/spotMicro/lcd_monitor)
  set(lcd_monitor_DEVEL_PREFIX /opt/app/spotMicro/devel)
  ...
  set(lcd_monitor_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lcd_monitor' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/app/spotMicro/lcd_monitor/${idir}'.  ${_report}")
    endif()
